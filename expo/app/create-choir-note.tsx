...
import { createChoirNote, listChoirMembers, uploadChoirFile } from '@/services/choir';
import type { ChoirMember } from '@/services/choir';

type SongSource = 'library' | 'external' | 'upload';

export default function CreateChoirNoteScreen() {
  ...
  return (
    <View style={styles.container}>
      <Stack.Screen options={{ title: "New Director's Note", headerShown: true }} />
      <KeyboardAvoidingView
